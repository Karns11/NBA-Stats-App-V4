...
const BasicLinePlot = ({ stats, playerTitle, averages }) => {
  const y =
    stats && stats.length > 0 && Object.values(stats).map((obj) => obj.pts);
  //console.log(y);
  ...
  const Avgy = averages;
  Object.values(averages).map((obj) => obj.pts);
          ...
          data={[
            {
              ...
              mode: "lines+markers",
              marker: { color: "blue" },
              name: "Player Points", // Add a name for the legend
            },
            {
              ...
              name: "Average Points", // Add a name for the legend
            },
          ]}
          layout={{
            title: `${playerTitle.first_name} ${playerTitle.last_name} Pts Per Game`,
            yaxis: { title: "Points" },
            xaxis: { title: "Date" },
          }}
        />
