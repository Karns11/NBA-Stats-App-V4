      ...
      <div id="L5Avg-table">
        ...
        <div className="mx-auto table-div-main mb-5">
          <table className="table mx-auto">
            {stats && stats.length > 0 && player && averages && teams && (
            ...
            <tbody>
              {stats && stats.length > 0 && player && averages && teams && (
                <tr className="table-light text-center">
                  ...
                  <td>
                    {parseFloat(LastFiveAvgFg_pct * 100).toFixed(2) + "%"}
                  </td>
                  <td>
                    {parseFloat(LastFiveAvgFg3_pct * 100).toFixed(2) + "%"}
                  </td>
                </tr>
              )}
            </tbody>
            ...
            {stats && stats.length > 0 && player && averages && teams && (
              <tbody>
                {validStats.map((validStat, ind) => {
                  ...
                  if (!team) return null; // Add a null check to handle undefined team
                  const opposingTeam =
